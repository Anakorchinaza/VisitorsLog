...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
        <h1 class="text-center mb-3 mt-5">{{ __('Register') }}</h1>
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="gender" class="col-md-4 col-form-check-label text-md-end">{{ __('Gender') }}</label>

                            <div class="col-md-6">
                                <input id="gender" type="radio" name="gender" class="form-check-input" value="male">Male
                                <input id="gender" type="radio" name="gender" class="form-check-input" value="female">Female
